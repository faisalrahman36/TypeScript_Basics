...
//Task 11
let  names= ['Maaz', 'Arham','Moiz', 'Mohib','Hania','Maira', 'Ammar','Zoya'];
...
let guests= ['Maaz', 'Arham','Moiz', 'Mohib','Hania','Maira', 'Ammar','Zoya'];
...
//printing new guests list
  ...
  let places= ['Mecca', 'Medina', 'Al-Quds', 'Srinagar', 'Istanbul']

  console.log('places in original array', places);
  
  console.log('places in alphabetical order without modifying original',[...places].sort());
  console.log('places in the original array', places);
  
  console.log('places in reverse alphabetical order without modifying original',[...places].sort().reverse());
  console.log('places in the original array', places);
...
let citiesObj= [{name:'Karachi' },{name: 'Lahore' },{name: 'Islamabad'}];
...
let indexGTMax: number= 3; //Index greater than max
let indexLTMin: number=-1; //Index less than minimum or zero for a non empty array
