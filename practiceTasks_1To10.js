...
// Task 2
var personName = " Faisal"; //only first name without spaces
...
var message1 = "Intelligence is the ability to adapt to change.";
console.log('%s once said, “%s”', famous_person, message1);
//Task 6
var personName2 = "  Syed\tFaisal ur \n Rahman      ";
...
Start Program */
var num1 = 5; //number 1
var num2 = 10; //number 2
var num3 = num1 + num2; //adding numbers 1 and 2
